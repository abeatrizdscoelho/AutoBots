...
public class ManipuladorGlobal {
    ...
    public ResponseEntity<ErroRespostaDTO> manipularAccessDenied(AccessDeniedException ex) {
        ErroRespostaDTO erro = new ErroRespostaDTO("Acesso negado", ex.getMessage());
